...
function Ffp2:update(dt, player)
...
function Ffp2:onUnequip(player)
...
function Ffp2:canShoot()
    -- Vérifier si on peut tirer
    return self.shootTimer <= 0
end

function Ffp2:shoot(player, dirX, dirY, roomContext)
    -- Vérifier si on peut tirer
